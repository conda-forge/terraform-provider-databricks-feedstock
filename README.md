...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/terraform-provider-databricks-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/terraform-provider-databricks-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add terraform-provider-databricks
# for installing globally
pixi global install terraform-provider-databricks
```
...
It is possible to list all of the versions of `terraform-provider-databricks` available on your platform:
...
```
pixi search terraform-provider-databricks --channel conda-forge
```
